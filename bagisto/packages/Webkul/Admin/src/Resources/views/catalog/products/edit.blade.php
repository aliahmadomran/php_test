...
{{--                @include ('admin::catalog.products.accordians.shipping-method', ['cities' => $cities , 'product' => $product->id])--}}
                <accordian :title="'Custom shipping cost'" :active="false">
                    <div slot="body">
                        <div class="control-group" :class="[errors.has('page_title') ? 'has-error' : '']">
                            ...
                            <input type="text" class="control" name="defcost" value="" data-vv-as="&quot;defcost&quot;">
                        </div>
                        <div>
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($cities as $data)
                                    <tr>
                                        <td><input  name="default" type="checkbox">
                                        <td>{{$data['country']}}</td>
                                        <td>{{$data['city']}}</td>
                                        <td><input type="text" name="shipping_cost" placeholder=""></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
